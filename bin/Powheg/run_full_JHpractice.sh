...
#cd /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg
#source /cvmfs/cms.cern.ch/cmsset_default.sh
#eval `scramv1 runtime -sh`

export name=JHpractice
export cardInput=production/2017/13TeV/DYToLL_NNPDF31_13TeV_MllBinned/Z_ee_NNPDF31_13TeV_M_50_120.input
export process=Z
export noPdfCheck=0
export WORKDIR=/afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg
...
cp -p /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/JHpractice/powheg.input .
if [ -e /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/JHpractice/JHUGen.input ]; then
    cp -p /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/JHpractice/JHUGen.input .
fi

if [ -e /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/JHpractice/obj-gfortran/proclib ]; then
    mkdir ./obj-gfortran
    cp -pr /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/JHpractice/*.so /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/JHpractice/proclib obj-gfortran
fi 
...
cd $WORKDIR
python /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/make_rwl.py ${is5FlavorScheme} ${defaultPDF}
cd ${name}
...
patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/pdfweights.patch
patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/pwhg_lhepdf.patch

if [ "$process" = "WZ" ] || [ "$process" = "ZZ" ]; then
   patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/lhapdf_zanderighi.patch
fi

if [ "$process" = "b_bbar_4l" ]; then
    cd POWHEG-BOX
    patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/res_openloops_long_install_dir.patch
    cd ..
fi
if [ "$process" = "ttb_NLO_dec" ]; then
    patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/pwhg_ttb_NLO_dec_gen_radiation_hook.patch
fi
if [ "$process" = "ZZ" ]; then
    patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/zz_m4lcut.patch
fi
if [ "$process" = "WWJ" ]; then
    patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/wwj-weights.patch
    cp /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/rwl_write_weights2_extra.f POWHEG-BOX/$process/
fi
...
if [ "$process" = "VBF_H" ]; then 
  ...
  patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/vbf_h_init_couplings.patch
fi  
if [ "$process" = "VBF_Z_Z" ]; then 
  patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/vbf_z_z_init_couplings.patch
fi  
if [ "$process" = "Wgamma" ] || [ "$process" = "W_ew-BMNNP" ]; then
    patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/pwhg_analysis_driver.patch 
fi
if [ "$process" = "HW_ew" ]; then
    patch -l -p0 -i /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/patches/hwew.patch 
fi
...
if [ $jhugen = 1 ]; then
  ...
  if [ ! -e /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/runcmsgrid_powhegjhugen.sh ]; then
   fail_exit "Did not find " /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/runcmsgrid_powhegjhugen.sh 
  fi
  sed -e 's/PROCESS/'${process}'/g' /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/runcmsgrid_powhegjhugen.sh > runcmsgrid.sh
else
  if [ ! -e /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/runcmsgrid_powheg.sh ]; then
   fail_exit "Did not find " /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/runcmsgrid_powheg.sh 
  fi
  sed -e 's/PROCESS/'${process}'/g' /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/runcmsgrid_powheg.sh > runcmsgrid.sh
fi
...
cd /afs/cern.ch/work/j/jihunk/CMSSW_10_1_6/src/genproductions/bin/Powheg/JHpractice/ 
export LD_LIBRARY_PATH=`pwd`/lib/:`pwd`/lib64/:${LD_LIBRARY_PATH} 

sed -i "s/NEVENTS/10/ ; s/SEED/42/" powheg.input

./pwhg_main 
echo "\nEnd of job on " `date` "\n" 
export folderName=JHpractice
