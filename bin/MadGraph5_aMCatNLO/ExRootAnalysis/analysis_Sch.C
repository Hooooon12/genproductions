    ...
    if(branchParticle->GetEntries() > 0) {
      ...
      if(lepcharge == 1){
        ...
        for(int Nparticle = 0; Nparticle < branchParticle->GetEntries(); Nparticle++){
          ...
          if(abs(particle->PID)==11||abs(particle->PID)==13) lepton_eta_tmp.push_back(particle->Eta);
          ...
          cout << particle->PID << ", Status : " << particle->Status << ", Mothers : " << particle->Mother1 << ", " << particle->Mother2 << ", pt : " << particle->PT << ", eta : " << particle->Eta << endl;
        }
        
        if(lepton_pt_tmp.at(0)>lepton_pt_tmp.at(1)) {
          lepton_pt.push_back(lepton_pt_tmp.at(0));
          lepton_pt.push_back(lepton_pt_tmp.at(1));
          lepton_eta.push_back(lepton_eta_tmp.at(0));
          lepton_eta.push_back(lepton_eta_tmp.at(1));
        }
        else {
          lepton_pt.push_back(lepton_pt_tmp.at(1));
          lepton_pt.push_back(lepton_pt_tmp.at(0));
        ...
        if(lepton_pt_tmp.at(0)==lepton_pt.at(0)) r1+=1;

        cout << "leading lepton pt : " << lepton_pt.at(0) << endl;
        cout << "subleading lepton pt : " << lepton_pt.at(1) << endl;
        cout << "leading lepton eta : " << lepton_eta.at(0) << endl;
        cout << "subleading lepton eta : " << lepton_eta.at(1) << endl;
...
//      histMass->Fill((vec1 + vec2).M());
  ...
  cout << "lep_w/l0 : " << (double)r1/Nevent << endl;
